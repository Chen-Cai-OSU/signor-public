...
fname = os.path.join(tb_util().fname(), '..', 'demo', '')
...
summary(all_features, 'all_features')
summary(all_labels, 'all_labels')
summary(all_images, 'all_images')
exit()
